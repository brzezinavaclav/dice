...
$return=array(
  ...
  <br><input type='text' class='_inv_amount' placeholder='Amount'><a class='btn' onclick='javascript:_invest();'>INVEST</a>
  <br><input type='text' class='_div_amount' placeholder='Amount'><a class='btn' onclick='javascript:_divest();'>DIVEST</a>
