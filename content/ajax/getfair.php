...
$return=array(
  'con' => "<p><b>Next Bet:</b></p>><br><small>Server Seed sha256:</small><br><br><small><small>".hash('sha256',$player['seedhash'].sprintf("%.32f",$player['server_seed']))."</small></small><br><br><p><b>Last Bet:</b></p>><br>".$c."<br><br><small><b>Note:</b> Decimals from 3rd place are cutted off.</small>"
);
