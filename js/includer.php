...
d+"px").css("background-color",a.isDark(e,i)?h.foreground:h.background).appendTo(f)}}a=c;jQuery(a).appendTo(this)})}})(jQuery);
    ...
    function account() {
      $.msgBox({
        title:"Account",
        content:"<br>Player Alias:<br><b><span id='alias_sp' style='display: inline;'><?php echo $player['alias']; ?></span></b><a class=\"fa fa-pencil\" onclick=\"javascript:_changeAlias(prompt('New alias:'));return false;\" ></a><br><br>Password:<br><span id='passwd_sp'><?php if ($player['password']!='') echo '<b>Yes</b><a class="fa fa-pencil" onclick=\"javascript:passwd_protect();return false;\" style=\"padding: 4px;\"></a> <button onclick=\"javascript:passwd_unprotect();return false;\" style=\"padding: 4px;\">Remove Password</button>'; else echo '<b>No</b><a class="fa fa-pencil" onclick=\"javascript:passwd_protect();return false;\" style=\"padding: 4px;\"></a>'; ?></span><br><small>Unique URL:</small><br><input class=\"l\" type=\"text\" style=\"width:100%;cursor:pointer;cursor:hand;\" onclick=\"$(this).select();\" value=\"http://<?php echo $settings['url']; ?>?unique=<?php echo $unique; ?>\"><br>",
        type:"info",
        opacity:0.8,
      });
      return false;    
