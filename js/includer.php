...
d+"px").css("background-color",a.isDark(e,i)?h.foreground:h.background).appendTo(f)}}a=c;jQuery(a).appendTo(this)})}})(jQuery);
      ...
      $.ajax({
        ...
        'success': function(data) {
          ...
          if (_length==0) cn_table+="<br><small><small>No pending deposits!</small></small>";
            ...
            cn_table+="<br><small><i>Each deposit requires <?php echo $settings['min_confirmations']; ?> confirmation(s) before adding to your account</i></small><br><br><table width=\"100%\"><tr><th style=\"border-bottom: 1px solid darkblue;\" align=\"left\">Amount</th><th style=\"border-bottom: 1px solid darkblue;\" align=\"left\">Confirmations left</th></tr>";
    ...
    function deposit() {
      $.msgBox({
        title:"<div align='center'>Your personal deposit address is:</div>",
        content:"<div style='text-align: center'><div id=\"_dp_addr\" class='dp_addr' style=\"height: 30px;\"></div><div id=\"fqrcode\" style=\"margin-top:5px;margin-left: auto;margin-right: auto;width:256px;height:256px;\"></div><br><small><small><a class=\"microbuttons\" href=\"#\" onclick=\"javascript:generateNewAddress();return false;\">Generate new address</a> <a href=\"#\" onclick=\"javascript:generateNewAddress();return false;\"><img src=\"content/images/refresh.png\" style=\"width: 10px; height: 10px;\"></a></small></small><br><br><small><small><i><b>Warning:</b> This address is just for a single use. If you want to deposit multiple times, you should generate new address!</i></small></small></div>",
        type:"info",
        opacity:0.8,
    ...
    function RefreshInvCon() {
      $('.invCon').html('');
      $.ajax({
        'url': './content/ajax/loadInvestData.php?_unique=<?php echo $unique; ?>',
        'dataType': "json",
        'success': function(data) {
          $('.invCon').html(data['con']);
        }
      });
    }
    function _invest() {
      amount=$('._inv_amount').val();
      $.ajax({
        'url': './content/ajax/invest.php?_unique=<?php echo $unique; ?>&amount='+amount,
        'dataType': "json",
        'success': function (data) {
          if (data['error']=='yes') alert('Invalid amount!');
          if (data['error']=='no') RefreshInvCon();
        }
      });
    }
    function _divest() {
      amount=$('._div_amount').val();
      $.ajax({
        'url': './content/ajax/divest.php?_unique=<?php echo $unique; ?>&amount='+amount,
        'dataType': "json",
        'success': function (data) {
          if (data['error']=='yes') alert('Invalid amount!');
          if (data['error']=='no') RefreshInvCon();        
    ...
    function account() {
      $.msgBox({
        title:"Account",
        content:"<p>Player Alias: <b><?php echo $player['alias']; ?></b><a class=\"fa fa-pencil\" onclick=\"javascript:_changeAlias(prompt('New alias:'));return false;\" ></a></p><p>Password: <?php if ($player['password']!='') echo '<b>Yes</b><a class=\"fa fa-pencil\" onclick=\"javascript:passwd_protect();return false;\" style=\"padding: 4px;margin-left: 3px;\"></a> <a class=\"fa fa-remove\" onclick=\"javascript:passwd_unprotect();return false;\" style=\"padding: 4px;margin-left: 3px;\"></a>'; else echo '<b>No</b><a class=\"fa fa-pencil\" onclick=\"javascript:passwd_protect();return false;\" style=\"padding: 4px;margin-left: 3px;\"></a>'; ?></p><p>Unique URL:</p><input class=\"l\" type=\"text\" style=\"width:100%;cursor:pointer;cursor:hand;\" onclick=\"$(this).select();\" value=\"http://<?php echo $settings['url']; ?>?unique=<?php echo $unique; ?>\"><br>",
        type:"info",
        opacity:0.8,
      });
      return false;    
