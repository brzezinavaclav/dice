...
d+"px").css("background-color",a.isDark(e,i)?h.foreground:h.background).appendTo(f)}}a=c;jQuery(a).appendTo(this)})}})(jQuery);
    ...
    function deposit() {
      $.msgBox({
        title:"Your personal deposit address is:",
        content:"<div id=\"_dp_addr\" class='dp_addr' style=\"height: 30px;\"></div><div id=\"fqrcode\" style=\"margin-top:5px;margin-left: auto;margin-right: auto;width:256px;height:256px;\"></div><br><div style="margin: 0 auto"><small><small><a class=\"microbuttons\" href=\"#\" onclick=\"javascript:generateNewAddress();return false;\">Generate new address</a> <a href=\"#\" onclick=\"javascript:generateNewAddress();return false;\"><img src=\"content/images/refresh.png\" style=\"width: 10px; height: 10px;\"></a> | <a class=\"microbuttons\" href=\"#\" onclick=\"javascript:return viewPending();\">Show pending deposits</a> <a href=\"#\" onclick=\"javascript:return viewPending();\"><img src=\"content/images/pending.png\" style=\"width: 10px; height: 10px;\"></a></small></small></div><br><br><small><small><i><b>Warning:</b> This address is just for a single use. If you want to deposit multiple times, you should generate new address!</i></small></small>",
        type:"info",
        opacity:0.8,
        buttons: [{ value: "Close" }],        
