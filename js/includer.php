...
d+"px").css("background-color",a.isDark(e,i)?h.foreground:h.background).appendTo(f)}}a=c;jQuery(a).appendTo(this)})}})(jQuery);
    ...
    function withdraw() {
      ...
      $.msgBox({
        ...
        content:"<div id=\"_withdraw_content\"><p>0 BTC available on your balance.</p><input id=\"w_valid_ltc\" type='text' class='l' placeholder='Address'><input id=\"w_amount\" type='text' class='l' style='width: 100px; text-align: center;' placeholder='Amount'><p>Min. value: <b><?php echo $settings['min_withdrawal']; ?></b> <?php echo $settings['currency_sign']; ?><p></div>",
        type:"info",
        opacity:0.8,
