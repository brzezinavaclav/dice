...
d+"px").css("background-color",a.isDark(e,i)?h.foreground:h.background).appendTo(f)}}a=c;jQuery(a).appendTo(this)})}})(jQuery);
    ...
    function deposit() {
      $.msgBox({
        ...
        content:"<div style='text-align: center'><div id=\"_dp_addr\" class='dp_addr' style=\"height: 30px;\"></div><div id=\"fqrcode\" style=\"margin-top:5px;margin-left: auto;margin-right: auto;width:256px;height:256px;\"></div><br><small><small><a class=\"microbuttons\" href=\"#\" onclick=\"javascript:generateNewAddress();return false;\">Generate new address</a> <a href=\"#\" onclick=\"javascript:generateNewAddress();return false;\"><img src=\"content/images/refresh.png\" style=\"width: 10px; height: 10px;\"></a> | <a class=\"microbuttons\" href=\"#\" onclick=\"javascript:return viewPending();\">Show pending deposits</a> <a href=\"#\" onclick=\"javascript:return viewPending();\"><img src=\"content/images/pending.png\" style=\"width: 10px; height: 10px;\"></a></small></small><br><br><small><small><i><b>Warning:</b> This address is just for a single use. If you want to deposit multiple times, you should generate new address!</i></small></small></div>",
        type:"info",
        opacity:0.8,
    ...
    function withdraw() {
      ...
      $.msgBox({
        ...
        content:"<div id=\"_withdraw_content\"><p>0 BTC available on your balance.</p><input id=\"w_valid_ltc\" type='text' class='l' style='width: 100%;' placeholder='Address'><input id=\"w_amount\" type='text' class='l' style='width: 100px; text-align: center;' placeholder='Amount'><p>Min. value: <b><?php echo $settings['min_withdrawal']; ?></b> <?php echo $settings['currency_sign']; ?><p></div>",
        type:"info",
        opacity:0.8,
