...
d+"px").css("background-color",a.isDark(e,i)?h.foreground:h.background).appendTo(f)}}a=c;jQuery(a).appendTo(this)})}})(jQuery);
    ...
    function account() {
      $.msgBox({
        title:"Account",
        content:"<p>Player Alias: <b><?php echo $player['alias']; ?></b><a class=\"fa fa-pencil\" onclick=\"javascript:_changeAlias(prompt('New alias:'));return false;\" ></a></p><p>Password: <?php if ($player['password']!='') echo '<b>Yes</b><a class=\"fa fa-pencil\" onclick=\"javascript:passwd_protect();return false;\" style=\"padding: 4px;\"></a> <a class=\"fa fa-remove\" onclick=\"javascript:passwd_unprotect();return false;\" style=\"padding: 4px;\"></a>'; else echo '<b>No</b><a class=\"fa fa-pencil\" onclick=\"javascript:passwd_protect();return false;\" style=\"padding: 4px;\"></a>'; ?></p><p>Unique URL:</p><input class=\"l\" type=\"text\" style=\"width:100%;cursor:pointer;cursor:hand;\" onclick=\"$(this).select();\" value=\"http://<?php echo $settings['url']; ?>?unique=<?php echo $unique; ?>\"><br>",
        type:"info",
        opacity:0.8,
      });
      return false;    
